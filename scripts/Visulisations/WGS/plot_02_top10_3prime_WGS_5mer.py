...
healthy = pd.read_csv(IN_DIR / "healthy_3prime_combined.tsv", sep=r"\s+", header=None, names=["motif", "count"])
cancer  = pd.read_csv(IN_DIR / "cancer_3prime_combined.tsv", sep=r"\s+", header=None, names=["motif", "count"])
...
plt.xlabel("3′ end 5-mer motifs")
plt.title("Top 10 WGS 3′ End Motifs (5-mer): Healthy vs Cancer")
...
out = OUT_DIR / "plot_02_top10_3prime_WGS_5mer.png"
