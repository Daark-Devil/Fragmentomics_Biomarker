...
healthy_file = IN_DIR / "healthy_5prime_combined.tsv"
cancer_file = IN_DIR / "cancer_5prime_combined.tsv"
...
plt.xlabel("5′ end motifs")
plt.title("Top 10 WGS 5′ End Motifs: Healthy vs Cancer")
...
out = OUT_DIR / "plot_01_top10_5prime_WGS.png"
