...
def load_fc(hfile, cfile, title, outname):
    ...
    m = h[["motif", "pct_h"]].merge(c[["motif", "pct_c"]], on="motif", how="outer").fillna(0)
...
load_fc(
    ...
    "WGS 5′ End-Motif Fold Change (5-mer)",
    "plot_04_foldchange_5prime_WGS_5mer.png"
)

load_fc(
    IN_DIR / "healthy_3prime_combined.tsv",
    IN_DIR / "cancer_3prime_combined.tsv",
    "WGS 3′ End-Motif Fold Change (5-mer)",
    "plot_04_foldchange_3prime_WGS_5mer.png"
)
